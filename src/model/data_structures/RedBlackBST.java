...
<<<<<<< HEAD
    ...
    ***************************************************************************/
    ...
    public Iterable<K> keys() {
        if (isEmpty()) return new ListaSencillamenteEncadenada<K>();
        return keys(min(), max());
    }
    ...
    // to the queue
    private void keys(Node x, ListaSencillamenteEncadenada<K> lista, K lo, K hi) { 
        if (x == null) return; 
...
>>>>>>> 11a224a3e868001eef3557e55212bf44e96fa96d
}
